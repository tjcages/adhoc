...
export class Browser extends React.Component {
    ...
    render() {       
        if (this.props.messagesResult.messages === [] || this.props.messagesResult === undefined) {
            console.log('FUCK ME!!!')
            return this.renderSpinner();
        } else if (this.props.messagesResult === undefined) {
            return (
        ...
        console.log('for fucks sake: ' + JSON.stringify(this.props.messagesResult.messages)) 
        // return this.renderMessage()
        return <h1>FUCK UOUUUUU</h1>
    }
}
