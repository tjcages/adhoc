...
export class Browser extends React.Component {
    ...
    render() {       
        if (this.props.match.params.id === undefined || this.props.messagesResult.messages.length === 0 || this.props.messagesResult.messages === undefined || this.props.emailMessageResult.loading) {
