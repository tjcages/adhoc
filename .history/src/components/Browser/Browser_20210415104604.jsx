        ...
        if (!emailMessageResult.loading) {
            if (!emailMessageResult.failed) {
                if (this.iframeRef.current) {
                    ...
                    var clean = DOMPurify.sanitize(this.props.emailMessageResult.body, {RETURN_DOM_FRAGMENT: true, RETURN_DOM_IMPORT: true});
            ...
            <div className="browser-container">
                ...
                <div className="browser-content" style={{top: -this.state.scrollY}}>
                    ...
                    <div>
                      ...
                      dangerouslySetInnerHTML={{__html: DOMPurify.sanitize(this.props.emailMessageResult.body)}}></div> */}
                      {/* <iframe
                        ref={this.iframeRef}
