...
export class Browser extends React.Component {
    ...
    renderMessage() {
        const message = this.props.messagesResult.messages.find(el => el.id === this.props.emailMessageResult.id)
        console.log("email: " + JSON.stringify(this.props.emailMessageResult)) 
        console.log("whole: " + JSON.stringify(this.props.messagesResult)) 
    ...
    render() {        
        ...
        } else if (this.props.messagesResult === undefined || this.props.emailMessageResult.body === "") {
            return (
