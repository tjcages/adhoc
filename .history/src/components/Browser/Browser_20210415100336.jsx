        ...
        if (!emailMessageResult.loading) {
            if (!emailMessageResult.failed) {
                if (this.iframeRef.current) {
                    ...
                    this.iframeRef.current.height = this.iframeRef.current.contentWindow.document.body.height
                    this.iframeRef.current.width = this.iframeRef.current.contentWindow.document.body.width
                }
            } else {
