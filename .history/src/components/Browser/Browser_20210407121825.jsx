...
export class Browser extends React.Component {
    ...
    renderMessage() {
        const receivedHeader = this.props.emailMessageResult.payload.headers.find(el => el.name.toUpperCase() === "X-RECEIVED");
        const date = receivedHeader ? receivedHeader.value.split(";")[1].trim() : "";
        let formattedDate =getFormattedDate(date, {date: this.props.emailMessageResult.internalDate, parserFn: parseInt});
        // const unread = message.labelIds.indexOf("UNREAD") > -1 ? " font-weight-bold" : "";
        // let selected = message.selected ? " selected" : "";
        const subjectHeader = this.props.emailMessageResult.payload.headers.find(el => el.name.toUpperCase() === "SUBJECT");
        const subject = subjectHeader ? subjectHeader.value : "";
        const fromHeader = this.props.emailMessageResult.payload.headers.find(el => el.name.toUpperCase() === "FROM");
    ...
    render() {        
        if (this.props.emailMessageResult.loading || this.props.emailMessageResult.) {
