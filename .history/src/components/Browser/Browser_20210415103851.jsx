        ...
        return (
            <div className="browser-container">
                ...
                <div className="browser-content" style={{top: -this.state.scrollY}}>
                    ...
                    <div>
                      {DOMPurify.sanitize(this.props.emailMessageResult.body, {RETURN_DOM: true})}
                      <div className="message-iframe" 
                      dangerouslySetInnerHTML={{__html: DOMPurify.sanitize(this.props.emailMessageResult.body, {RETURN_DOM: true})}}></div>
                      {/* <iframe
                        ref={this.iframeRef}
