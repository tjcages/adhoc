...
export class Browser extends React.Component {
    ...
    render() {        
        if (this.props.emailMessageResult.loading || this.props.messageResult.loading) {
            return this.renderSpinner();
        } else if (this.props.emailMessageResult === undefined || this.props.messageResult === undefined) {
            return (
