...
const variants = {
  open: {  position: "absolute", width: "100%", marginLeft: 0 },
  closed: { position: "relative", marginTop: 32, width: "50%", marginLeft: 32 },
}
  ...
  return (
    <div id="container">
      ...
      <div className="web-container">
        ...
        <motion.div className="web-arbox" onClick={() => setFullPage(!fullPage)} animate={fullPage ? "open" : "closed"} variants={variants} />
      </div>
    </div>
  )
}
