...
export class Navigation extends React.Component {
  ...
  renderMessages() {
    ...
    console.log(this.props.messagesResult.messages.filter(el => el.labelIds.length === 2))
    console.log(this.props.messagesResult.messages.filter(el => el.labelIds.includes("UPDATES")))
      ...
      labels.map((label) => { 
        return (
          <div>
            ...
            {
              this.props.messagesResult.messages.filter(el => el.labelIds.includes(label)).map((el, index) => {
                return (
                  <InboxItem
                    data={el}
                    nextId={nextId}
