...
export class InboxItem extends React.PureComponent {
    ...
    render() {      
      ...
      return (
        <div className={this.props.selected ? 'inbox-container selected' : 'inbox-container'} onClick={ this.props.onClick(false) }>
          ...
          <div className={this.props.selected ? 'inbox-options selected' : 'inbox-options'}>
            <BiCheck className="inbox-icon" onClick={ this.props.onClick(true) } />
          </div>
        </div>
      )
    }
