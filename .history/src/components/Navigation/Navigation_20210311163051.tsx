...
export default function Navigation() {
  return (
    <GridList cellHeight={'10vh'} spacing={1} className="grid_list">
        {tileData.map((tile) => (
        <GridListTile className="navigation_tile" key={tile.img} cols={tile.featured ? 2 : 1} rows={tile.featured ? 2 : 1}>
