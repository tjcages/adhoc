    ...
    return (
      <div className="note-container">
        <div className="note-content">
          ...
          <h4 className="note-h4 h4" style={{marginBottom: '6px'}}>Subject haha tickle me elmo idk what else to write about at this moment</h4>
          <h4 className="note-h4 h4" style={{opacity: 0.5}}>Date</h4>
        </div>
      </div>
    )
  }
