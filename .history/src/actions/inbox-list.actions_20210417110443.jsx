...
import { selectLabel } from "./label-list.actions";
...
export const SET_REPLY_STATE = "SET_REPLY_STATE";
...
export const setReplyState = ({ state = false, message }) => dispatch => {
  console.log('setting state')
  modifyMessageState({state, message})
  .then(modifiedMessage => {
    console.log('setReplyState: ' + state)
    dispatch({
...
const modifyMessageState = ({ state, message }) => {
  message.replyState = state
