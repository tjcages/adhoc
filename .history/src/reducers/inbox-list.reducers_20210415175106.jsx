...
import {
  ...
  const defaultReplyState = {
    isReplying: false
  }

  export const replyState = (state = defaultReplyState, action) => {
    console.log('here!' + JSON.stringify(action.state))
    switch (action.type) {
      case SET_R EPLY_STATE:
  ...
  const defaultReadingStatsResult = {
    text: "",
    loading: false,
    failed: false
  };
