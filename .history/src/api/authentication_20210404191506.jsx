export const signIn = () => {
  ...
  export const initGmailClient = (apiKey, clientId) => {
    ...
    const SCOPES = "https://www.googleapis.com/auth/calendar.events https://www.googleapis.com/auth/gmail.modify"; // Scope for Read, send, delete, and manage your email
